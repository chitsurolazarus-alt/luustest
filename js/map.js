...
const MapManager = {
    ...
    // Look up an address typed by the customer (OpenStreetMap Nominatim - free, no API key)
    async geocodeAddress(query) {
        ...
        if (!results || results.length === 0) throw new Error('Could not find that location. Try a more specific address.');
